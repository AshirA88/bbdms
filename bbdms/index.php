...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <!--h4 class="my-4">Made by Ashir, Priya and Diksha</h4-->
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Tips Before Donating Blood</h4>

                        <p class="card-text" style="padding-left:2%"> 1.  Drink an extra 16 oz. of water (or other nonalcoholic drink) before your appointment. </p>
                        <p class="card-text" style="padding-left:2%"> 2.  Eat a healthy meal, avoiding fatty foods like hamburgers, fries or ice cream.</p>
                        <p class="card-text" style="padding-left:2%"> 3.  Wear a shirt with sleeves that you can roll up above your elbows.</p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who you could Help</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">⁂ Cancer Patients.</p>
                        <p class="card-text" style="padding-left:2%">⁂ Trauma Patients.</p>
                        <p class="card-text" style="padding-left:2%">⁂ Sickle Cell Patients.</p>
                        <p class="card-text" style="padding-left:2%">⁂ Burn Patients.</p>
                        <p class="card-text" style="padding-left:2%">⁂ Patients with Chronic Diseases.</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
{ ?>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top img-fluid" src="images/tenor.gif" alt="" ></a>
...
<li>AB positive or AB negative.</li>
        ...
        <div class="row mb-4">
            ...
            <h4>UNIVERSAL DONORS AND RECIPIENTS</h4>
                <p>The most common blood type is O, followed by type A.
