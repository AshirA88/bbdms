    <nav class="navbar fixed-top navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <div class="container">
            <a class="navbar-brand" href="index.php">Blood Donation Management System</a>
            <div class="collapse navbar-collapse" id="navbarExample">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item" style="color:green;"><b>
                      <a class="nav-link" href="admin/index.php">Log in</a></b>
                  </li>
